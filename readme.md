...
> _Given a PE file, what is the probability that it is malicious?_
...
_Note: These metrics reflect general PE malware detection. Ransomware-specific precision depends on the composition of malicious samples in the training set._
